...
export default function Procard(props) {
    ...
    return (
        <div onClick={handleRedirect} className="bg-white text-gray-800 rounded-xl p-6 shadow-lg  hover:shadow-xl transition-all duration-300 hover:scale-105 max-w-full">
