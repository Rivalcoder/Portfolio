import { FaInstagram, FaGithub, FaLinkedin, FaTelegram, FaJava } from "react-icons/fa";
    ...
    return (
        <div className="bg-[#03002e] text-white w-full h-auto font-[Poppins] max-h-max text-2xl">
            <header className="fixed z-20 w-full bg-[#03002e]">
                ...
                <div className="flex flex-row self-start">
                    ...
                    <ul className={`flex flex-row gap-10 text-xl mr-4 max-sm:flex-col max-sm:${click?"hidden":"flex"} max-sm:p-5 max-sm:self-start max-sm:bg-[#060335] max-sm:w-full `}>
                        ...
                        <li className="hover:scale-110 transition-all duration-200 "><a href="#Contact" className="hover:border-b-[3px] p-2 transition-all rounded-sm max-sm:p-5 ">Contact</a></li>
                    </ul>
                </nav>
            </header>
            ...
            <section className="flex flex-col justify-center items-center min-h-screen">
                ...
                <div className="grid grid-cols-5 mt-16 max-sm:grid-cols-2">
            ...
            <section className="pt-24 flex flex-col justify-center items-center">
                ...
                <div className="grid grid-cols-2 gap-9 w-[70%] max-sm:grid-cols-1">
            ...
            <section className="pt-24 flex flex-col justify-center items-center pb-10 lg:mt-5">
                <footer className="flex flex-col gap-10 justify-center items-center">
                    ...
                    <div className="flex gap-10 max-sm:flex-col ">
                        <a className="hover:scale-110 text-white hover:text-red-600 transition-all duration-200" href="https://github.com/Rivalcoder" target="_blank">GitHub</a>
                        <a className="hover:scale-110 text-white hover:text-red-600 transition-all duration-200" href="https://www.instagram.com/rival_coder?utm_source=qr&igshid=YnQ3dWxwdXFvMWNi" target="_blank">Instagram</a>
                        <a className="hover:scale-110 text-white hover:text-red-600 transition-all duration-200" href="https://www.linkedin.com/in/divyaprakash-r-349746292?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">LinkedIn</a>
                        <a className="hover:scale-110 text-white hover:text-red-600 transition-all duration-200" href="http://t.me/divyaprakash_1" target="_blank">Telegram</a>
                        <a className="hover:scale-110 text-white hover:text-red-600 transition-all duration-200" href="mailto:rivalcoder01@gmail.com">Email</a>
                    </div>
                    <div className="flex flex-col gap-3 justify-center items-center text-base">
                        <p>Rivalcoder owned by Divyaprakash</p>
                        <p>Copyright &copy; 2024 by @rivalcoder.vercel.app | All Rights Reserved.</p>
                    </div>
                </footer>
            </section>
        </div>
